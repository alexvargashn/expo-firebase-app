    ...
    async facebook() {
        ...
        if(type === "success") {
            ...
            firebase.auth().signInWithCredential(credentials)
                .catch(error => {
                    Toast.showWithGravity('Error al acceder vía facebook', Toast.LONG, Toast.BOTTOM);
                });
        } else if(type === "cancel") {
            Toast.showWithGravity('Inicio de sesión cancelado.', Toast.LONG, Toast.BOTTOM);
        } else {
            Toast.showWithGravity('Error desconocido, vuelva a intentar más tarde', Toast.LONG, Toast.BOTTOM);
        }
    }
