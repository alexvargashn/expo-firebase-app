...
export default class Register extends Component {
    constructor() {
        ...
        this.samePassword = t.refinement(t.String, (s) => {
            console.log(this.state.user.password, this.user.password_confirmation);
        ...
        this.options = {
            fields: {
                ...
                password_confirmation: {
                    ...
                    error: 'Los passwors no coinciden',
                    password: true,
                    secureTextEntry: true
                }
            }
    ...
    render() {
        return (
            <BackgroundImage source = {require('../../assets/images/login-wall.png')}>
                <View>
